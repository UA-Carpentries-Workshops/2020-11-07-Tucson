...
venue: "University of Arizona (online)"        # brief name of the institution that hosts the workshop without address (e.g., "Euphoric State University")
...
humandate: "Nov 7-8, 2020"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
...
instructor: ["Katherine Busby", "Hagan Franks", "Kelsey Gonzalez", "Uwe Hilgert", "Artin Majdi", "Isabella Viney"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Dwight Nwaigwe", "Austin Rutherford"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
collaborative_notes: https://pad.carpentries.org/2020-11-07-Tucson # optional: URL for the workshop collaborative notes, e.g. an Etherpad or Google Docs document (e.g., https://pad.carpentries.org/2015-01-01-euphoria)
